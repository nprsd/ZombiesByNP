...
public class WeaponManager : MonoBehaviour
{
	...
	void Update()
    {
		if(primaryWeapon != Weapon.None && Input.GetButtonDown("switch") && currentWeapon != primaryWeapon)
        {
		...
		else if(secondaryWeapon != Weapon.None && Input.GetButtonDown("switch") && currentWeapon != secondaryWeapon)
        {
			currentWeaponGO.GetComponent<WeaponBase>().Unload();
