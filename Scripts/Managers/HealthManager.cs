...
public class HealthManager : MonoBehaviour
{
    ...
    public static bool enableHeartBeat = false;

    void Start()
    {
        health = 100.0f;
		animator = GetComponent<Animator>();
        anim = GameObject.FindGameObjectWithTag("damageIndicator").GetComponent<Animator>();
        if (isPlayer)
        {
            healthText = GameObject.Find("UI/InGameUI/WeaponStatus/HealthText").GetComponent<Text>();
        }
	}
